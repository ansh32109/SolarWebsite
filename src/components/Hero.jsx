...
const Hero = () => {
  ...
  return (
    <div className='flex w-[100vw] items-center container bg-gradient-to-b from-[#FFDD00]/60 via-[#FFA500]/60 to-[#FF4500]/60 h-screen'>
        <div className='grid w-full grid-cols-3 text-black h-[70vh]'>
